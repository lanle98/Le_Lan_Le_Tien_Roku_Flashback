...
--
-- Host: localhost:8889
-- Generation Time: Apr 12, 2020 at 12:40 AM
...
CREATE TABLE `tbl_movies` (
  ...
  `movie_online` varchar(200) NOT NULL
...
CREATE TABLE `tbl_music` (
  ...
  `music_info` varchar(40) NOT NULL,
  `music_runtime` varchar(20) NOT NULL,
  `music_online` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tbl_music` (`music_id`, `music_name`, `music_poster`, `music_year`, `music_singer`, `music_type`, `music_link`, `IMDb`, `music_info`, `music_runtime`, `music_online`) VALUES
(1, 'Can\'t Help Falling In Love', 'Elvis-Presley.jpg', '1961', 'Elvis Presley', 'parents', 'Cant Help Falling In Love.mp4', '', '', '', 'https://www.youtube.com/watch?v=vGJTaP6anOU'),
(2, 'Why Don\'t You Believe Me', 'Joni James.jpg', '1954', 'Joni James', 'parents', 'Why Dont You Believe Me.mp4', '', '', '', 'https://www.youtube.com/watch?v=sHJQ6BGyFXg'),
(3, 'Close to you', 'Carpenters.jpg', '1970', 'Carpenters', 'parents', 'Close to you.mp4', '', '', '', 'https://www.youtube.com/watch?v=iFx-5PGLgb4'),
(4, 'Little Jeannie', 'Elton John.jpg', '1980', 'Elton John', 'parents', 'Little Jeannie.mp4', '', '', '', 'https://www.youtube.com/watch?v=Wlz6mTyiMZc'),
(5, 'Baby One More Time', 'Britney Spears.jpg', '1998', 'Britney Spears', 'parents', 'Baby One More Time.mp4', '', '', '', 'https://www.youtube.com/watch?v=C-u5WLJ9Yk4'),
(6, 'Witch Doctor', 'Witch Doctor.jpg', '1958', 'Ross Bagdasarian Sr.', 'Kids', 'Witch Doctor.mp4', '', '', '', 'https://www.youtube.com/watch?v=TYgOlqinH7A'),
(7, 'Sugar, Sugar', 'The Archies.jpg', '1969', 'The Archies', 'Kids', 'SugarSugar.mp4', '', '', '', 'https://www.youtube.com/watch?v=h9nE2spOw_o'),
(8, 'There\'s a Hippo in My Tub', 'Anne Murray.jpg', '1977', 'Anne Murray', 'Kids', 'Theres a Hippo in My Tub.mp4', '', '', '', 'https://www.youtube.com/watch?v=Dr3KXPZ3I0k'),
(9, 'Every Breath You Take\r\n', 'The Police.jpg', '1983', 'The Police', 'Kids', 'Every Breath You Take.mp4', '', '', '', 'https://www.youtube.com/watch?v=OMOGaugKpzs'),
(10, 'Cuppy Cake Song ', 'Cuppy Cake Song.jpg', '1995', 'Buddy Castle', 'Kids', 'Cuppy Cake Song.mp4', '', '', '', 'https://www.youtube.com/watch?v=h4srcLhIJZI');
...
CREATE TABLE `tbl_television` (
  ...
  `tv_link` varchar(100) NOT NULL,
  `tv_type` varchar(20) NOT NULL,
  `IMDb` varchar(20) NOT NULL,
  `tv_genres` varchar(50) NOT NULL,
  `tv_online` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tbl_user` (`user_id`, `user_name`, `user_pass`, `name`, `authority`, `avatar`) VALUES
(1, 'lanle98', '123', 'Lan', 'parents', 'daddy.svg'),
(2, 'tienle', '123', 'Tien', 'kids', 'mama.svg');
